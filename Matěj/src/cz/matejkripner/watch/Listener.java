...
public class Listener {
     ...
     *
     * @see cz.matejkripner.watch.ListenerConfig
     */
    ...
    /**
     * If this listener is well filled, register it to given ListenerGroup. Otherwise throw an {@link cz.matejkripner.watch.Listener.BadFilledException}
     * @param group The {@link cz.matejkripner.watch.ListenerGroup}, to which should be this listener registered
     */
    ...
    /**
     * Check, if this listener is well filled and throw an {@link cz.matejkripner.watch.Listener.BadFilledException} when no.
